...
public class ClassMetrics {
    ...
    /**
     * Return true if the class name is part of fengdai sources
     */
    public static boolean isfengdaiclass(String s) {
    	return (s.startsWith("com.fengdai"));
    }
    /**
     * Return true if the class name is part of funds||account sources
     */
    public static boolean isfundsclass(String s) {
    	return (s.startsWith("com.tairanchina"));
    }
