...
public class MetricsFilter {
    ...
    public static void main(String[] argv){
    	String[] test={"F:\\ckjm\\workspace\\core-mqnotify\\target\\classes\\com\\fengdai\\mqnotify\\msg\\MsgSender.class"};
//    	String[] test={"F:\\ckjm\\core-activity-0.0.1.M1-SNAPSHOT.jar"};
    	testmain(test);
    }
}
